...
openssl req -newkey rsa:4096 -addext "extendedKeyUsage = emailProtection,clientAuth" -keyform PEM -keyout server-key.pem -out server-req.csr -outform PEM -sha256 -subj "/C=Pol/ST=Dolno/L=Wro/O=PolWro/OU=WiIT/CN=Jonatan_Kasperczak/emailAddress=259418@student.pwr.edu.pl"
